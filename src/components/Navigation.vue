<template>
    <div class="z-20 bg-white fixed h-screen  border-r-2 shadow-lg rounded-tr-3xl rounded-br-3xl">
        <nav class="flex flex-col items-center flex-shrink-0 w-16 py-4 bg-transparent">
            <!-- Logo -->
